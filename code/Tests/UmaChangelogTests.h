...
void runAllStressTests(bool debug) {
    ...
    std::cout << "Stress test 5 took " << std::chrono::duration_cast<std::chrono::seconds>(t15 - t05).count() << " s" << std::endl;
    
    auto t06 = std::chrono::steady_clock::now();
    stressTest6<genomeName>(debug);
    auto t16 = std::chrono::steady_clock::now();
    std::cout << "Stress test 6 took " << std::chrono::duration_cast<std::chrono::seconds>(t16 - t06).count() << " s" << std::endl;
    
    auto t07 = std::chrono::steady_clock::now();
    stressTest7<genomeName>(debug);
    auto t17 = std::chrono::steady_clock::now();
    std::cout << "Stress test 7 took " << std::chrono::duration_cast<std::chrono::seconds>(t17 - t07).count() << " s" << std::endl;
