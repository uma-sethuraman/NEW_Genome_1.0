...
/* This testing suite is made up of consistency
   and stress tests for genome functions.

   TO RUN THESE TESTS ON ANY GENOME:
    - in the main.cpp file, include "UmaTests.h"
    - in the main method, call UmaTests::runAllTests<genomeName>(debug),
...
namespace UmaTests {
    ...
    /* removing at a position that was previously
       inserted at and previously removed */
    template <class genomeName>
    void removeTest15(bool debug) {

        // original genome of size 15: all values equal to 10
        AbstractGenome* genome = new genomeName(15);
        for (int i(0); i < genome->size(); i++) {
            GN::genomeWrite(genome, i, (std::byte)10);
        }
        ...
        // insert 55 at position 5
        genome->insert(5, std::vector<std::byte>({(std::byte)55}));

        // remove position 5 (which was just inserted at)
        genome->remove(5, 1);

        /* remove positions 4,5,6,7,8, 
           position 5 was previously inserted at and previously removed */
        genome->remove(4, 5);

        /* original genome: 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10
        after mutation 1: 10 10 10 10 10 55 10 10 10 10 10 10 10 10 10 10
        after mutation 2: 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10
        after mutation 3: 10 10 10 10 10 10 10 10 10 10
        current genome: 10 10 10 10 10 10 10 10 10 10 */
        ...
        // correct answer (genome of size 10): 10 10 10 10 10 10 10 10 10 10
        std::vector<std::byte> answer(10, (std::byte)10);
        
        printResults(answer, genome, "Remove Test 15: ");
